...
This project is indexed by GitNexus as **MealPlanner** (2334 symbols, 3438 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
